// GENERATED by scripts/generate-icons.mjs from apps/desktop/src/lib/icons.ts at hermes-agent commit
...
export type { Icon as IconComponent } from '@tabler/icons-react-native'
