...
//
// Six of the mobile prototype's rows (Chat, Safety, Memory & Context,
// Billing, Archived chats, About) and Toolsets have no route yet — each
// lands in its own later M14 commit, per the milestone's own task order.
import { t } from '../lib/t'
