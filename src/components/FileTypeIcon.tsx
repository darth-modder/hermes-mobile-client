// Ported from apps/desktop/src/components/ui/file-type-icon.tsx.

import { codiconForFilename, codiconForLanguage } from '../lib/file-icons'

import { ToolIcon, type ToolIconProps } from './ToolIcon'
...
/**
 * Icon for a file or code language, resolved through the mapping shared with
 * code blocks (`codiconForFilename` / `codiconForLanguage`). Renders via
