// Ported from apps/desktop/src/components/ui/tool-icon.tsx. Codicons are an
// outline icon font — an outline glyph has no fillable region, so a filled
// look can't be derived from it. The desktop renders dedicated solid SVG
// paths (Phosphor Icons, MIT, "fill" weight, 256x256 viewBox) for the tool
 ...
 *  not covered by the solid set, so an unrecognised tool still gets an icon. */
export function ToolIcon({ accessibilityLabel, color, name, size = 14, style }: ToolIconProps) {
