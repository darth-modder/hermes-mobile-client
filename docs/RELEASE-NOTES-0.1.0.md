...
- **A notification when you're not looking.** If an approval comes in while you've switched away
  from the app, you get a real system notification. The app asks for notification permission once,
  the first time you send a message — never at launch, before it has anything to notify you about.
...
1. Download the APK from the release and open it — your phone will ask permission to install from
   this source once; allow it.
